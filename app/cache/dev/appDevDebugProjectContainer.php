...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'eventoeventobundle.descontoactions' => 'getEventoeventobundle_DescontoactionsService',
            'eventoeventobundle.eventoactions' => 'getEventoeventobundle_EventoactionsService',
            'eventoeventobundle.eventouseractions' => 'getEventoeventobundle_EventouseractionsService',
            ...
            'tritoq.manager.boleto' => 'getTritoq_Manager_BoletoService',
            'twig' => 'getTwigService',
    ...
    /**
     * Gets the 'colihcorebundle.atualizacaoactions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Core\BaseBundle\Services\AtualizacaoActions A Core\BaseBundle\Services\AtualizacaoActions instance.
     */
    protected function getColihcorebundle_AtualizacaoactionsService()
    {
        return $this->services['colihcorebundle.atualizacaoactions'] = new \Core\BaseBundle\Services\AtualizacaoActions($this->get('doctrine.orm.default_entity_manager'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Core\UserBundle\Services\UserActions A Core\UserBundle\Services\UserActions instance.
     */
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'dbABRHDF', 'user' => 'root', 'password' => 'mario85', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2e1f3c3644f5ec31af86b5f37cc785d31c7203bf4d094d7fbfb3c93236d7d7a4');
    ...
    /**
     * Gets the 'eventoeventobundle.descontoactions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Evento\EventoBundle\Services\DescontoActions A Evento\EventoBundle\Services\DescontoActions instance.
     */
    protected function getEventoeventobundle_DescontoactionsService()
    {
        return $this->services['eventoeventobundle.descontoactions'] = new \Evento\EventoBundle\Services\DescontoActions($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'eventoeventobundle.eventoactions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Evento\EventoBundle\Services\EventoActions A Evento\EventoBundle\Services\EventoActions instance.
     */
    protected function getEventoeventobundle_EventoactionsService()
    {
        return $this->services['eventoeventobundle.eventoactions'] = new \Evento\EventoBundle\Services\EventoActions($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'eventoeventobundle.eventouseractions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Evento\EventoBundle\Services\EventoUserActions A Evento\EventoBundle\Services\EventoUserActions instance.
     */
    protected function getEventoeventobundle_EventouseractionsService()
    {
        return $this->services['eventoeventobundle.eventouseractions'] = new \Evento\EventoBundle\Services\EventoUserActions($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'tritoq.manager.boleto' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tritoq\Bundle\ManagerBoletoBundle\Service\BoletoManager A Tritoq\Bundle\ManagerBoletoBundle\Service\BoletoManager instance.
     */
    protected function getTritoq_Manager_BoletoService()
    {
        $this->services['tritoq.manager.boleto'] = $instance = new \Tritoq\Bundle\ManagerBoletoBundle\Service\BoletoManager();

        $instance->setConfigurations(array('boleto' => array('tipo' => 'bancodobrasil', 'agencia' => 2039, 'carteira' => 18, 'conta' => 12039101, 'convenio' => 1234, 'dias_prazo' => 3, 'endereco' => 'Endereço 01', 'cidade' => 'Cidade', 'uf' => 'SC', 'cnpj' => '04.544.191/0001-03', 'cedente' => 'Empresa')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Core/BaseBundle/Resources/views'), 'CoreBase');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5586a46d24ee37c9392ef3e35de4d135f5c5f38b');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TritoqManagerBoletoBundle' => 'Tritoq\\Bundle\\ManagerBoletoBundle\\TritoqManagerBoletoBundle',
                'CoreBaseBundle' => 'Core\\BaseBundle\\CoreBaseBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'dbABRHDF',
            'database_user' => 'root',
            'database_password' => 'mario85',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '5586a46d24ee37c9392ef3e35de4d135f5c5f38b',
            ...
            'kernel.secret' => '5586a46d24ee37c9392ef3e35de4d135f5c5f38b',
            ...
            'tritoq.manager.boleto.configurations' => array(
                'boleto' => array(
                    'tipo' => 'bancodobrasil',
                    'agencia' => 2039,
                    'carteira' => 18,
