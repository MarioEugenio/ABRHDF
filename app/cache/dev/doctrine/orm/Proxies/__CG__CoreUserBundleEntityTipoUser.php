 ...
 */
class TipoUser extends \Core\UserBundle\Entity\TipoUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Core\\UserBundle\\Entity\\TipoUser' . "\0" . 'id', '' . "\0" . 'Core\\UserBundle\\Entity\\TipoUser' . "\0" . 'nome', '' . "\0" . 'Core\\UserBundle\\Entity\\TipoUser' . "\0" . 'descricao');
        }
